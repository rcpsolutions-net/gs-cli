...
function createWebhookCommands() {
  ...
  webhooks
    .command("create <eventName> <callback-url> [hmac-key]")
    .description(
  ...
  webhooks
    .command("subscribe <id> <eventName>")
    .description(
  ...
  webhooks
    .command("unsubscribe <id> <eventName>")
    .description(
