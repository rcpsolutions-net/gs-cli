        ...
        try {
           spinner.text = 'Step 1 of 1: Requesting API access token for clientId: ' + clientId;
            ...
            if (newToken) {
               ...
               spinner.info(chalk.blue(`GET /workspaces response contains ${workspaceResponse.data.length} workspaces.\n`));
                ...
                if( fnd ) {
                    ...
                    spinner.info(chalk.cyan(`Authenticated to workspace: ${workspaceName} (ID: ${workspaceId})`));
                    console.log();
